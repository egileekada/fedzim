...
export default function ThirdSection() {
    return (
        <div className=' w-full px-6 lg:px-24 grid grid-cols-1 lg:grid-cols-2 gap-y-16 gap-6 py-14' >
            <div className=' w-full flex items-center justify-center' > 
                <img src={HeroImage} className=' w-full' alt='hero' />
            </div> 
            <div className=' lg:w-96 mx-auto flex flex-col justify-center ' >
            ...
            <div className=' lg:w-96 mx-auto flex flex-col justify-center ' >
                ...
                <p className=' font-PublicSans-Regular text-sm my-6' >The world will be a better place if we keep records and pay close attention to our physical and environmental health. </p> 
                <p className=' font-PublicSans-SemiBold text-2xl' >Patient Memo</p>
                <p className=' font-PublicSans-Regular text-sm my-6' >Patient Memo helps to keep a healthy and responsive health system in place. Patients Memo enables your hospital in keeping accurate digital records of your patients and allows you to update and reach  them in minutes</p>
            </div>
            <div className=' w-full flex items-center justify-center' > 
