                ...
                <div className='w-auto' >
                    <div className=' w-12 h-14 rounded-lg flex justify-center items-center bg-[#FFFFFF1B]' >
                        <svg width="30" height="43" viewBox="0 0 37 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.8182 3.63647H28.1818C30.8554 3.63647 33.0227 6.07856 33.0227 9.09102V30.9092C33.0227 33.9217 30.8554 36.3637 28.1818 36.3637H8.8182C6.14464 36.3637 3.97729 33.9217 3.97729 30.9092V9.09102C3.97729 6.07856 6.14464 3.63647 8.8182 3.63647ZM28.1818 7.27284H8.8182C7.92702 7.27284 7.20457 8.08687 7.20457 9.09102V30.9092C7.20457 31.9134 7.92702 32.7274 8.8182 32.7274H28.1818C29.073 32.7274 29.7955 31.9134 29.7955 30.9092V9.09102C29.7955 8.08687 29.073 7.27284 28.1818 7.27284ZM24.9546 14.5456C25.8458 14.5456 26.5682 15.3596 26.5682 16.3637C26.5682 17.2962 25.9453 18.0647 25.1428 18.1697L24.9546 18.1819H12.0455C11.1543 18.1819 10.4318 17.3679 10.4318 16.3637C10.4318 15.4313 11.0548 14.6628 11.8573 14.5578L12.0455 14.5456H24.9546ZM23.3409 23.6365C23.3409 22.6323 22.6185 21.8183 21.7273 21.8183H12.0455L11.8573 21.8305C11.0548 21.9356 10.4318 22.704 10.4318 23.6365C10.4318 24.6406 11.1543 25.4547 12.0455 25.4547H21.7273L21.9155 25.4424C22.718 25.3374 23.3409 24.5689 23.3409 23.6365Z" fill="white"/>
                        </svg>
                    </div> 
