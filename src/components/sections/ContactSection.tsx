...
export default function ContactSection() {
    return (
        <div className=' bg-[#E834D5] lg:h-56 px-6 lg:px-0 relative w-full flex flex-col lg:flex-row lg:items-center py-12 lg:-mb-36 lg:rounded-md  ' >
            ...
            <button className='flex items-center w-40 lg:w-auto text-sm bg-[#230B6D] mt-16 lg:mt-0 text-white rounded lg:ml-auto lg:mr-14 h-10 font-PublicSans-Bold px-6 ' >Contact Us
